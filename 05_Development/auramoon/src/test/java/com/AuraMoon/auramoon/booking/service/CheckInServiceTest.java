...
public class CheckInServiceTest {
        ...
        public void checkIn_validRequest_updatesStatusesAndEncryptsID() {
                ...
                when(consentRepository.findFirstByUser_IdOrderByUpdatedAtDesc(guestId))
        ...
        public void checkIn_futureCheckinDate_throwsException() {
                ...
                Booking booking = Booking.builder()
                                ...
                                .guestId(guestId)
                                .bookingStatus("CONFIRMED")
                                .checkinDate(LocalDateTime.now().plusDays(1)) // Ngày nhận phòng ở tương lai
                                .build();
        ...
        public void checkIn_noConsent_throwsException() {
                ...
                assertTrue(exception.getMessage()
                                .contains("Khách hàng chưa đồng ý điều khoản bảo mật dữ liệu cá nhân"));
