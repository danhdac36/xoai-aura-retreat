...
public class NightAuditController {
    ...
    public String showDashboard(Model model) {
        ...
        model.addAttribute("data", nightAuditService.getDashboardData());
    ...
    public String executeManualAudit(RedirectAttributes redirectAttributes) {
        try {
            ...
            redirectAttributes.addFlashAttribute("errorMessage",
                    "Night Audit has already been completed for this date.");
        } catch (Exception e) {
            // E2: Lỗi hệ thống (BIL-004) - MSG-21
            redirectAttributes.addFlashAttribute("errorMessage",
                    "Night Audit process failed. Please review the error log and retry manually.");
        }
