...
|    BR-24    |       Maximum Active Booking per Guest Constraint      |                                          Each guest is allowed a maximum of one (1) active booking (status PENDING, CONFIRMED, or CHECKED_IN) at any given time to prevent overlapping schedules and resource conflicts. Guests must complete or cancel their current booking before initiating a new one.                                         |              UC07              |
### 5.2 System Messages
