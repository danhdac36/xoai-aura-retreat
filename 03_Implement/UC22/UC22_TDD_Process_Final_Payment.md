...
| --- | --- | --- | --- | --- |
| `BIL-TC-001` | `CheckoutControllerTest.java` | `[ ]` | `[ ]` | |
| `BIL-TC-002` | `CheckoutControllerTest.java` | `[ ]` | `[ ]` | |
| `BIL-TC-003` | `CheckoutControllerTest.java` | `[ ]` | `[ ]` | |
...
## Exit Criteria
- [ ] Tất cả các test cases qua (Green)
- [ ] VNPay callback signature verify 100% không thể bypass
